...
{
	std::cout << "LogFlippedReal: " << message << "\n";
}
...
template <class T>
T* SpawnActor(FVector Location, FRotator Rotation = FRotator{ 0, 0, 0 }, UClass* Class = T::StaticClass(), FVector Scale3D = { 1,1,1 }, ESpawnActorCollisionHandlingMethod SpawnMethod = ESpawnActorCollisionHandlingMethod::AlwaysSpawn)
{
	FQuat Quat{};
...
UClass* SpawnActor2(UClass* Class, FVector Location, FQuat Rotation, FVector Scale3D = { 1,1,1 }, ESpawnActorCollisionHandlingMethod SpawnMethod = ESpawnActorCollisionHandlingMethod::AlwaysSpawn)
{
	FTransform Transform{};
