...
{
public:
	TArray<struct FVoteSessionSettings>          VoteSessionSettingsList;                           // 0x200(0x10)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                        Pad_3D7C[0x90];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	TArray<struct FVoteSelection>                SupportedVoteSelections;                           // 0x190(0x10)(Edit, Net, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
