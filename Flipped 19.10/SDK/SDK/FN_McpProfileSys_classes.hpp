...
public:
	...
	uint8                                        Pad_123D[0x57];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_123F[0x15];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1246[0xB4];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_124B[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_124C[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                LockCode;                                          // 0x1A8(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UMcpProfile*>                   LockedProfiles;                                    // 0x1B8(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_1251[0x56];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	int32                                        ItemLogThreshold;                                  // 0x254(0x4)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class FString>                        ForwardToClientExclusions;                         // 0x258(0x10)(ZeroConstructor, Config, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_1259[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
