...
public:
	...
	TArray<struct FWebEnvUrl>                    WebCreateEpicAccountUrl;                           // 0xB8(0x10)(ZeroConstructor, Config, Protected, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_1212[0x36];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1214[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1216[0x29F];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_121A[0x330];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_121B[0x37];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_121D[0x34];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_121E[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
