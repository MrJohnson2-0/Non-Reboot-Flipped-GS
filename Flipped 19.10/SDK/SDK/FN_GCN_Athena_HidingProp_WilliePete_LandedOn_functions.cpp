...
class UClass* UGCN_Athena_HidingProp_WilliePete_LandedOn_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Athena_HidingProp_WilliePete_LandedOn_C");

	return Clss;
}


// GCN_Athena_HidingProp_WilliePete_LandedOn_C GCN_Athena_HidingProp_WilliePete_LandedOn.Default__GCN_Athena_HidingProp_WilliePete_LandedOn_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Athena_HidingProp_WilliePete_LandedOn_C* UGCN_Athena_HidingProp_WilliePete_LandedOn_C::GetDefaultObj()
{
	static class UGCN_Athena_HidingProp_WilliePete_LandedOn_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Athena_HidingProp_WilliePete_LandedOn_C*>(UGCN_Athena_HidingProp_WilliePete_LandedOn_C::StaticClass()->DefaultObject);
