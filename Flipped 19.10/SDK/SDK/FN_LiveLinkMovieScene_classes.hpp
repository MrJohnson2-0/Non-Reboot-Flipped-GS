...
public:
	...
	TArray<class UMovieSceneLiveLinkSubSection*> SubSections;                                       // 0x130(0x10)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                        Pad_401B[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_401D[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_401E[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_401F[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4020[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
