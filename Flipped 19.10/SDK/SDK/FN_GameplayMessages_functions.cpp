...
class UClass* AGameplayMessageReplicator::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class AGameplayMessageReplicator* AGameplayMessageReplicator::GetDefaultObj()
{
	static class AGameplayMessageReplicator* Default = nullptr;

	if (!Default)
		Default = static_cast<AGameplayMessageReplicator*>(AGameplayMessageReplicator::StaticClass()->DefaultObject);
