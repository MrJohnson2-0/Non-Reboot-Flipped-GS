...
public:
	...
	uint8                                        Pad_45B7[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_45BB[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TSet<class UPhysicalMaterial*>               ChaosBreakingMaterialSet;                          // 0x138(0x50)(Edit, UObjectWrapper, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_45C0[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
