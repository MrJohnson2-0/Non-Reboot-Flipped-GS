...
// Parameters:
// enum class EDataLayerState         InPrerollState                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UMovieSceneDataLayerSection::SetPrerollState(enum class EDataLayerState InPrerollState)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// enum class EDataLayerState         InDesiredState                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UMovieSceneDataLayerSection::SetDesiredState(enum class EDataLayerState InDesiredState)
{
	static class UFunction* Func = nullptr;
...
enum class EDataLayerState UMovieSceneDataLayerSection::GetPrerollState()
{
	static class UFunction* Func = nullptr;
...
enum class EDataLayerState UMovieSceneDataLayerSection::GetDesiredState()
{
	static class UFunction* Func = nullptr;
