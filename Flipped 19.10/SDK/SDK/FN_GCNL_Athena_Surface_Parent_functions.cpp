...
class UClass* AGCNL_Athena_Surface_Parent_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCNL_Athena_Surface_Parent_C");

	return Clss;
}


// GCNL_Athena_Surface_Parent_C GCNL_Athena_Surface_Parent.Default__GCNL_Athena_Surface_Parent_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCNL_Athena_Surface_Parent_C* AGCNL_Athena_Surface_Parent_C::GetDefaultObj()
{
	static class AGCNL_Athena_Surface_Parent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCNL_Athena_Surface_Parent_C*>(AGCNL_Athena_Surface_Parent_C::StaticClass()->DefaultObject);
...
void AGCNL_Athena_Surface_Parent_C::OnRemoval(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	static class UFunction* Func = nullptr;
