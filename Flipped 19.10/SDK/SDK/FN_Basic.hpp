...
namespace FMemory
{
	static inline void (*Free)(void* Array) = decltype(Free)(__int64(GetModuleHandleW(0)) + 0xafe310);
	static inline void* (*Realloc)(void*, __int64, unsigned int) = decltype(Realloc)(__int64(GetModuleHandleW(0)) + 0x1a1927c);
}
...
public:
	...
	uint8                                        Pad_76F6[0x4];                                     // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_76F7[0x8];                                     // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	int32                                        ElementSize;                                       // (0x3C[0x04]) NOT AUTO-GENERATED PROPERTY
	uint64                                       PropertyFlags;                                     // (0x40[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_76F8[0x4];                                     // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_76F9[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_76FA[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_76FB[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_76FC[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_76FD[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_76FE[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_76FF[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_7700[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
