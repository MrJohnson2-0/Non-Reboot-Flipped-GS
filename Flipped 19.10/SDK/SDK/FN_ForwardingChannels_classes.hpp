...
{
public:
	TArray<TScriptInterface<class IForwardingChannelFactory>> ForwardingChannelFactories;                        // 0x30(0x10)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                        Pad_4027[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
