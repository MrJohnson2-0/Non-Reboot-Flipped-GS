...
public:
	...
	TArray<struct FVoteSelectionSettings>        VoteSelections;                                    // 0x28(0x10)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
public:
	...
	class FName                                  VoteSessionId;                                     // 0x18(0x8)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                  VoteId;                                            // 0x20(0x8)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class FName>                          VoteSelectionIds;                                  // 0x28(0x10)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_3DAE[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
