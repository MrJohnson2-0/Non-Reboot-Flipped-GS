...
public:
	...
	uint8                                        Pad_7554[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FVector                               LocalPlayerLocation;                               // 0x494(0xC)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FScalableFloat                        StencilDuration;                                   // 0x4B8(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
