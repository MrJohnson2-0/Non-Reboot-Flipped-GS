...
void AGCNL_Athena_AppleSun_Bounced_C::ReceiveTick(float DeltaSeconds)
{
	...
	Params::AGCNL_Athena_AppleSun_Bounced_C_ReceiveTick_Params Parms{};
...
void AGCNL_Athena_AppleSun_Bounced_C::OnLoopingStart(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static class UFunction* Func = nullptr;
	...
	Params::AGCNL_Athena_AppleSun_Bounced_C_OnLoopingStart_Params Parms{};
