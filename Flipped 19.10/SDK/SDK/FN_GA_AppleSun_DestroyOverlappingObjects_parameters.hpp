...
public:
	...
	uint8                                        Pad_5C06[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	TArray<struct FActiveGameplayEffectHandle>   CallFunc_ApplyGameplayEffectContainer_ReturnValue; // 0xC0(0x10)(ConstParm, ReferenceParm)
