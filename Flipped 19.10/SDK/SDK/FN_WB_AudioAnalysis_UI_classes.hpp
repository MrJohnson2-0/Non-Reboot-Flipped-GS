...
public:
	...
	class UVerticalBox*                          GraphBox;                                          // 0x250(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	TArray<class UWB_AudioAnalysis_FloatGraph_C*> Widgets;                                           // 0x258(0x10)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
