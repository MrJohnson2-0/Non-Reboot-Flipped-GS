...
public:
	...
	uint8                                        Pad_43EC[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_43EE[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        BitPad_2CE : 7;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        BitPad_2CF : 6;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	uint8                                        Pad_43F9[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTimeSynthFilterSettings              FilterASettings;                                   // 0x704(0xC)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FTimeSynthFilterSettings              FilterBSettings;                                   // 0x710(0xC)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FTimeSynthEnvelopeFollowerSettings    EnvelopeFollowerSettings;                          // 0x720(0xC)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_43FB[0xA20];                                   // Fixing Size Of Struct [ Dumper-7 ]
