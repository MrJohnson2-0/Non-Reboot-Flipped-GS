...
class UClass* UGCN_MultiInteractionRemove_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_MultiInteractionRemove_C");

	return Clss;
}


// GCN_MultiInteractionRemove_C GCN_MultiInteractionRemove.Default__GCN_MultiInteractionRemove_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_MultiInteractionRemove_C* UGCN_MultiInteractionRemove_C::GetDefaultObj()
{
	static class UGCN_MultiInteractionRemove_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_MultiInteractionRemove_C*>(UGCN_MultiInteractionRemove_C::StaticClass()->DefaultObject);
