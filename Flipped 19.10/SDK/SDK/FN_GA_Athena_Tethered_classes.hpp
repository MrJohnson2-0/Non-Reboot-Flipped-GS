...
public:
	...
	struct FScalableFloat                        BreakStructuresOnTetherEnabled;                    // 0xAE0(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        BreakStructuresOnTetherRange;                      // 0xB08(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayTag                          Event_FishingForceEnd;                             // 0xB30(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
