...
class UClass* AGCN_Loop_PlayerWorldPFX_Persistent_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Loop_PlayerWorldPFX_Persistent_C");

	return Clss;
}


// GCN_Loop_PlayerWorldPFX_Persistent_C GCN_Loop_PlayerWorldPFX_Persistent.Default__GCN_Loop_PlayerWorldPFX_Persistent_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCN_Loop_PlayerWorldPFX_Persistent_C* AGCN_Loop_PlayerWorldPFX_Persistent_C::GetDefaultObj()
{
	static class AGCN_Loop_PlayerWorldPFX_Persistent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCN_Loop_PlayerWorldPFX_Persistent_C*>(AGCN_Loop_PlayerWorldPFX_Persistent_C::StaticClass()->DefaultObject);
...
// class AFortPlayerCameraSpectator*  K2Node_DynamicCast_AsFort_Player_Camera_Spectator                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_DynamicCast_bSuccess_1                                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_K2_AttachToComponent_ReturnValue                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsLocallyControlled_ReturnValue                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_BooleanOR_ReturnValue                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AActor*                      K2Node_Event_MyTarget_3                                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
