...
bool ITestTypedElementInterfaceA::SetDisplayName(struct FTypedElementHandle& InElementHandle, class FText InNewName, bool bNotify)
{
...
class FText ITestTypedElementInterfaceA::GetDisplayName(struct FTypedElementHandle& InElementHandle)
{
	static class UFunction* Func = nullptr;
...
bool ITestTypedElementInterfaceB::MarkAsTested(struct FTypedElementHandle& InElementHandle)
{
	static class UFunction* Func = nullptr;
...
bool ITestTypedElementInterfaceC::GetIsTested(struct FTypedElementHandle& InElementHandle)
{
	static class UFunction* Func = nullptr;
...
bool UTypedElementHandleLibrary::NotEqual(struct FTypedElementHandle& LHS, struct FTypedElementHandle& RHS)
{
	static class UFunction* Func = nullptr;
...
bool UTypedElementHandleLibrary::IsSet(struct FTypedElementHandle& ElementHandle)
{
	static class UFunction* Func = nullptr;
...
bool UTypedElementHandleLibrary::Equal(struct FTypedElementHandle& LHS, struct FTypedElementHandle& RHS)
{
	static class UFunction* Func = nullptr;
...
void UTypedElementListLibrary::Reserve(const struct FTypedElementListProxy& ElementList, int32 Size)
{
	static class UFunction* Func = nullptr;
...
bool UTypedElementListLibrary::Remove(const struct FTypedElementListProxy& ElementList, struct FTypedElementHandle& ElementHandle)
{
	static class UFunction* Func = nullptr;
...
bool UTypedElementListLibrary::IsValidIndex(const struct FTypedElementListProxy& ElementList, int32 Index)
{
	static class UFunction* Func = nullptr;
...
bool UTypedElementListLibrary::HasElementsOfType(const struct FTypedElementListProxy& ElementList, class FName ElementTypeName)
{
	static class UFunction* Func = nullptr;
...
bool UTypedElementListLibrary::HasElements(const struct FTypedElementListProxy& ElementList, TSubclassOf<class IInterface> BaseInterfaceType)
{
	static class UFunction* Func = nullptr;
...
class UObject* UTypedElementListLibrary::GetElementInterface(const struct FTypedElementListProxy& ElementList, struct FTypedElementHandle& ElementHandle, TSubclassOf<class IInterface> BaseInterfaceType)
{
	static class UFunction* Func = nullptr;
...
TArray<struct FTypedElementHandle> UTypedElementListLibrary::GetElementHandles(const struct FTypedElementListProxy& ElementList, TSubclassOf<class IInterface> BaseInterfaceType)
{
	static class UFunction* Func = nullptr;
...
struct FTypedElementHandle UTypedElementListLibrary::GetElementHandleAt(const struct FTypedElementListProxy& ElementList, int32 Index)
{
	static class UFunction* Func = nullptr;
...
void UTypedElementListLibrary::Empty(const struct FTypedElementListProxy& ElementList, int32 Slack)
{
	static class UFunction* Func = nullptr;
...
struct FTypedElementListProxy UTypedElementListLibrary::CreateElementList(class UTypedElementRegistry* Registry)
{
	...
	if (!Func)
		Func = Class->GetFunction("TypedElementListLibrary", "CreateElementList");

	Params::UTypedElementListLibrary_CreateElementList_Params Parms{};
...
int32 UTypedElementListLibrary::CountElementsOfType(const struct FTypedElementListProxy& ElementList, class FName ElementTypeName)
{
	static class UFunction* Func = nullptr;
...
int32 UTypedElementListLibrary::CountElements(const struct FTypedElementListProxy& ElementList, TSubclassOf<class IInterface> BaseInterfaceType)
{
	static class UFunction* Func = nullptr;
...
bool UTypedElementListLibrary::Contains(const struct FTypedElementListProxy& ElementList, struct FTypedElementHandle& ElementHandle)
{
	static class UFunction* Func = nullptr;
...
void UTypedElementListLibrary::Append(const struct FTypedElementListProxy& ElementList, TArray<struct FTypedElementHandle>& ElementHandles)
{
	static class UFunction* Func = nullptr;
...
bool UTypedElementListLibrary::Add(const struct FTypedElementListProxy& ElementList, struct FTypedElementHandle& ElementHandle)
{
	static class UFunction* Func = nullptr;
...
class UObject* UTypedElementRegistry::GetElementInterface(struct FTypedElementHandle& InElementHandle, TSubclassOf<class IInterface> InBaseInterfaceType)
{
	static class UFunction* Func = nullptr;
