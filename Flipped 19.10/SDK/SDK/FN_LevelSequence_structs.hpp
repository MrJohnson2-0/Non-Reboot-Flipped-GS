...
{
public:
	uint8                                        Pad_152C[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	class ULevelSequence*                        ActiveShot;                                        // 0xA8(0x8)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
