...
public:
	...
	TArray<class UErrorLlama_C*>                 K2Node_MakeArray_Array;                            // 0x88(0x10)(ReferenceParm, ContainsInstancedReference)
	...
	bool                                         CallFunc_IsMobileGame_ReturnValue;                 // 0xD8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
