...
class UClass* UGCN_Athena_HidingProp_WilliePete_Exit_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Athena_HidingProp_WilliePete_Exit_C");

	return Clss;
}


// GCN_Athena_HidingProp_WilliePete_Exit_C GCN_Athena_HidingProp_WilliePete_Exit.Default__GCN_Athena_HidingProp_WilliePete_Exit_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Athena_HidingProp_WilliePete_Exit_C* UGCN_Athena_HidingProp_WilliePete_Exit_C::GetDefaultObj()
{
	static class UGCN_Athena_HidingProp_WilliePete_Exit_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Athena_HidingProp_WilliePete_Exit_C*>(UGCN_Athena_HidingProp_WilliePete_Exit_C::StaticClass()->DefaultObject);
