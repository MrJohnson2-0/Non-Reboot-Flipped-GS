...
{
public:
	struct FSlateBrush                           RimBrush;                                          // 0x0(0xB0)(Edit, BlueprintVisible)
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush;                      // 0xB0(0xB0)(None)
	class UOverlaySlot*                          K2Node_DynamicCast_AsOverlay_Slot;                 // 0x160(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_1235[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
