...
public:
	...
	uint8                                        Pad_4457[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	class USoundfieldEffectSettingsBase*         Settings;                                          // 0x28(0x8)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_445A[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
