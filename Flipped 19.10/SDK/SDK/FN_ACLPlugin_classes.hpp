...
public:
	...
	uint8                                        Pad_1299[0xD8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	uint32                                       MaxStreamRequestSizeKB;                            // 0x120(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_129B[0x1C];                                    // Fixing Size Of Struct [ Dumper-7 ]
