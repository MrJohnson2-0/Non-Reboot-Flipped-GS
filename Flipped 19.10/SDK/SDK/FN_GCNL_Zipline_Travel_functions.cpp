...
class UClass* AGCNL_Zipline_Travel_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCNL_Zipline_Travel_C");

	return Clss;
}


// GCNL_Zipline_Travel_C GCNL_Zipline_Travel.Default__GCNL_Zipline_Travel_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCNL_Zipline_Travel_C* AGCNL_Zipline_Travel_C::GetDefaultObj()
{
	static class AGCNL_Zipline_Travel_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCNL_Zipline_Travel_C*>(AGCNL_Zipline_Travel_C::StaticClass()->DefaultObject);
...
void AGCNL_Zipline_Travel_C::OnApplicationGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
...
void AGCNL_Zipline_Travel_C::OnRemovalGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	static class UFunction* Func = nullptr;
