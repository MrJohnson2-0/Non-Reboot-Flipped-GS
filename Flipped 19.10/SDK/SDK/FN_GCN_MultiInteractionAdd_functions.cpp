...
class UClass* UGCN_MultiInteractionAdd_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_MultiInteractionAdd_C");

	return Clss;
}


// GCN_MultiInteractionAdd_C GCN_MultiInteractionAdd.Default__GCN_MultiInteractionAdd_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_MultiInteractionAdd_C* UGCN_MultiInteractionAdd_C::GetDefaultObj()
{
	static class UGCN_MultiInteractionAdd_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_MultiInteractionAdd_C*>(UGCN_MultiInteractionAdd_C::StaticClass()->DefaultObject);
