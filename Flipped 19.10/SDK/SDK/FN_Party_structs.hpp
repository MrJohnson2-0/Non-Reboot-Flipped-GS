...
public:
	...
	struct FUniqueNetIdRepl                      UniqueId;                                          // 0x58(0x28)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FPartyMemberPlatformData              PlatformData;                                      // 0x20(0x90)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_EE1[0x90];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_EE2[0x37];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_EE5[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_EEA[0x35];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_EEB[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
