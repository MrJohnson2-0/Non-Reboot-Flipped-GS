...
public:
	...
	uint8                                        Pad_6FF[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FSlateBrush                           OverrideBrush;                                     // 0x20(0xB0)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FCommonInputTypeInfo                  KeyboardInputTypeInfo;                             // 0x40(0xD0)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FCommonInputTypeInfo                  DefaultGamepadInputTypeInfo;                       // 0x110(0xD0)(Edit, Protected, NativeAccessSpecifierProtected)
	TMap<class FName, struct FCommonInputTypeInfo> GamepadInputOverrides;                             // 0x1E0(0x50)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FCommonInputTypeInfo                  TouchInputTypeInfo;                                // 0x230(0xD0)(Edit, Protected, NativeAccessSpecifierProtected)
};
