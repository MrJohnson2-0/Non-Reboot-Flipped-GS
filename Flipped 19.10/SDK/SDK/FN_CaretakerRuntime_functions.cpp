...
class UClass* AFortAthenaCaretakerAIController::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class AFortAthenaCaretakerAIController* AFortAthenaCaretakerAIController::GetDefaultObj()
{
	static class AFortAthenaCaretakerAIController* Default = nullptr;

	if (!Default)
		Default = static_cast<AFortAthenaCaretakerAIController*>(AFortAthenaCaretakerAIController::StaticClass()->DefaultObject);
