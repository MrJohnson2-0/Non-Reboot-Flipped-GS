...
public:
	...
	TArray<class APointLight*>                   Pointlights;                                       // 0x240(0x10)(Edit, BlueprintVisible, DisableEditOnTemplate)
	...
	TArray<class AEmitter*>                      ParticleSystems;                                   // 0x260(0x10)(Edit, BlueprintVisible, DisableEditOnTemplate)
	bool                                         IsActive;                                          // 0x270(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         DebugLOWQualityLighting;                           // 0x271(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         LOW_FX_Setting_Use_MobileLighting;                 // 0x288(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         IsLightalreadyActive;                              // 0x289(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                          MPCMinusManualSunlightColor;                       // 0x29C(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
