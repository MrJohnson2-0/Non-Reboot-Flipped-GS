...
class UClass* UGCN_Zipline_ApplyBrakes_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Zipline_ApplyBrakes_C");

	return Clss;
}


// GCN_Zipline_ApplyBrakes_C GCN_Zipline_ApplyBrakes.Default__GCN_Zipline_ApplyBrakes_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Zipline_ApplyBrakes_C* UGCN_Zipline_ApplyBrakes_C::GetDefaultObj()
{
	static class UGCN_Zipline_ApplyBrakes_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Zipline_ApplyBrakes_C*>(UGCN_Zipline_ApplyBrakes_C::StaticClass()->DefaultObject);
