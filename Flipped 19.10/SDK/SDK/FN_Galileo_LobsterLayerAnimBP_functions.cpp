...
void UGalileo_LobsterLayerAnimBP_C::ItemPreIK(const struct FPoseLink& InPose_PreIK, struct FPoseLink* ItemPreIK)
{
	...
	Params::UGalileo_LobsterLayerAnimBP_C_ItemPreIK_Params Parms{};
...
void UGalileo_LobsterLayerAnimBP_C::ItemFullBodyOverride(const struct FPoseLink& InPoseFullBody, struct FPoseLink* ItemFullBodyOverride)
{
	static class UFunction* Func = nullptr;
	...
	Params::UGalileo_LobsterLayerAnimBP_C_ItemFullBodyOverride_Params Parms{};
...
void UGalileo_LobsterLayerAnimBP_C::ItemAimOffset(const struct FPoseLink& InPose_AimOffset, float AimOffsetAlpha, float Yaw, float Pitch, const struct FPoseLink& InPose_UpperLowerPreMeleeAO, struct FPoseLink* ItemAimOffset)
{
	static class UFunction* Func = nullptr;
	...
	Params::UGalileo_LobsterLayerAnimBP_C_ItemAimOffset_Params Parms{};
