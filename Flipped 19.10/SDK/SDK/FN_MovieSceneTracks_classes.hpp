...
{
public:
	class UMovieSceneSection*                    SectionToKey;                                      // 0x90(0x8)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                        Pad_176B[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	TArray<class UMovieSceneSection*>            ConstraintSections;                                // 0x90(0x10)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
public:
	...
	class UMovieScenePropertyInstantiatorSystem* InstantiatorSystem;                                // 0x48(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	struct FMovieSceneDoubleChannel              Translation[0x3];                                  // 0xF8(0x1F8)(NativeAccessSpecifierPrivate)
	struct FMovieSceneDoubleChannel              Rotation[0x3];                                     // 0x2F0(0x1F8)(NativeAccessSpecifierPrivate)
	struct FMovieSceneDoubleChannel              Scale[0x3];                                        // 0x4E8(0x1F8)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel               ManualWeight;                                      // 0x6E0(0xA0)(NativeAccessSpecifierPrivate)
	bool                                         bUseQuaternionInterpolation;                       // 0x780(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_178B[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	class USoundBase*                            Sound;                                             // 0xE8(0x8)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_1796[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class USoundAttenuation*                     AttenuationSettings;                               // 0x300(0x8)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	class UEnum*                                 Enum;                                              // 0xC0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	class UCameraAnim*                           CameraAnim;                                        // 0x108(0x8)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	TArray<class UMovieSceneSection*>            CameraAnimSections;                                // 0x98(0x10)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_17B8[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	TArray<class UMovieSceneSection*>            CameraShakeSections;                               // 0x98(0x10)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
{
public:
	class FString                                ShotDisplayName;                                   // 0x128(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FText                                  DisplayName;                                       // 0x138(0x18)(Deprecated, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_17E6[0x180];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_17E9[0x1E0];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	TArray<struct FActorDataLayer>               DataLayers;                                        // 0xF0(0x10)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	enum class EDataLayerState                   DesiredState;                                      // 0x100(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	enum class EDataLayerState                   PrerollState;                                      // 0x101(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_17F7[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]

	static class UClass* StaticClass();
	static class UMovieSceneDataLayerSection* GetDefaultObj();

	void SetPrerollState(enum class EDataLayerState InPrerollState);
	void SetDesiredState(enum class EDataLayerState InDesiredState);
	void SetDataLayers(TArray<struct FActorDataLayer>& InDataLayers);
	enum class EDataLayerState GetPrerollState();
	enum class EDataLayerState GetDesiredState();
...
{
public:
	uint8                                        Pad_17F8[0x90];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	TArray<class UMovieSceneSection*>            Sections;                                          // 0x90(0x10)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_17FC[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	struct FMovieSceneDoubleChannel              DoubleCurve;                                       // 0xF0(0xA8)(Protected, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                        Pad_1812[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1820[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<class UMovieSceneSection*>            Sections;                                          // 0xA8(0x10)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_1835[0x1A8];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_183F[0x168];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	class UMaterialParameterCollection*          MPC;                                               // 0xA8(0x8)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_184F[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	TSubclassOf<class UObject>                   PropertyClass;                                     // 0xC8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<class UMovieSceneSection*>            ParticleSections;                                  // 0x98(0x10)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_185A[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_185D[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_185F[0xC0];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1864[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1867[0xC0];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_186B[0x48];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	class UMovieSceneSequencePlayer*             SequencePlayer;                                    // 0x60(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class USceneComponent*                       SceneComponent;                                    // 0x68(0x8)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_1883[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1885[0x90];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_188F[0x208];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	struct FMovieSceneSkeletalAnimationParams    Params;                                            // 0xE8(0xE0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class UAnimSequence*                         AnimSequence;                                      // 0x1C8(0x8)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UAnimSequenceBase*                     Animation;                                         // 0x1D0(0x8)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_1897[0x4F];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_18A5[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	struct FMovieSceneDoubleChannel              Curves[0x4];                                       // 0xF0(0x2A0)(NativeAccessSpecifierPrivate)
	int32                                        ChannelsUsed;                                      // 0x390(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_18B5[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_18B6[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
