...
class UClass* ASidewaysPlayspace::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class ASidewaysPlayspace* ASidewaysPlayspace::GetDefaultObj()
{
	static class ASidewaysPlayspace* Default = nullptr;

	if (!Default)
		Default = static_cast<ASidewaysPlayspace*>(ASidewaysPlayspace::StaticClass()->DefaultObject);
...
class UClass* ASidewaysVolume::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class ASidewaysVolume* ASidewaysVolume::GetDefaultObj()
{
	static class ASidewaysVolume* Default = nullptr;

	if (!Default)
		Default = static_cast<ASidewaysVolume*>(ASidewaysVolume::StaticClass()->DefaultObject);
