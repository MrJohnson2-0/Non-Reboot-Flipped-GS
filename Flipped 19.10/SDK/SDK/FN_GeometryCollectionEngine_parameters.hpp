...
public:
	...
	uint8                                        Pad_4936[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FHitResult                            OutHit;                                            // 0x18(0x9C)(Parm, OutParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0xB4(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_4945[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
