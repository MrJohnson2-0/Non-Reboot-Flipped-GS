...
public:
	...
	uint8                                        CallFunc_GetActorTeam_ReturnValue;                 // 0x1C8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                            CallFunc_K2_SetWorldLocation_SweepHitResult;       // 0x1E0(0x9C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	TArray<class AFortPlayerController*>         Temp_object_Variable;                              // 0x288(0x10)(ConstParm, ReferenceParm)
	TArray<enum class EFortTeamAffiliation>      K2Node_MakeArray_Array;                            // 0x298(0x10)(ReferenceParm)
};
