...
public:
	...
	uint8                                        BitPad_2E1 : 7;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_4691[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	class UObject*                               FoliageTypeObject;                                 // 0x0(0x8)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFoliageType*                          TypeInstance;                                      // 0x8(0x8)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	class UFoliageType*                          Type;                                              // 0x30(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_469E[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
