...
{
public:
	class UConversationRegistry*                 ConversationRegistry;                              // 0x0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UConversationInstance*                 ActiveConversation;                                // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UConversationParticipantComponent*     ClientParticipant;                                 // 0x10(0x8)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UConversationTaskNode*                 TaskBeingConsidered;                               // 0x18(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	struct FGameplayTag                          EntryTag;                                          // 0x0(0x8)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<class UScriptStruct*>                 IndexToScriptStructs;                              // 0x50(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
};
