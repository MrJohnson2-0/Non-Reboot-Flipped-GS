...
void UFortUIManagerComponent_VictoryCrowns::HandleGamePhaseStepChanged(TScriptInterface<class IFortSafeZoneInterface>& SafeZoneInterface, enum class EAthenaGamePhaseStep GamePhaseStep)
{
	static class UFunction* Func = nullptr;
...
void UVictoryCrownsIndicator::OnTargetActorChanged(class AActor* TargetedActor)
{
	...
	Params::UVictoryCrownsIndicator_OnTargetActorChanged_Params Parms{};
...
// Parameters:
// class AFortPlayerStateAthena*      ReturnValue                                                      (ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UVictoryCrownsPreGameWidget::HandleGamePhaseStepChanged(TScriptInterface<class IFortSafeZoneInterface>& SafeZoneInterface, enum class EAthenaGamePhaseStep GamePhaseStep)
{
	static class UFunction* Func = nullptr;
