...
public:
	...
	uint8                                        Pad_4824[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4828[0xA];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            DrawWorldOffset;                                   // 0x10(0x30)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                        DrawSize;                                          // 0x40(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4831[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_4832[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_4836[0x198];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	struct FRigElementKey                        Root;                                              // 0xD0(0xC)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4837[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FFBIKEndEffector>              Effectors;                                         // 0xE0(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FFBIKConstraintOption>         Constraints;                                       // 0xF0(0x10)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FSolverInput                          SolverProperty;                                    // 0x100(0x24)(NoDestructor, NativeAccessSpecifierPublic)
	struct FMotionProcessInput                   MotionProperty;                                    // 0x124(0x2)(NoDestructor, NativeAccessSpecifierPublic)
	bool                                         bPropagateToChildren;                              // 0x126(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4838[0x9];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FFBIKDebugOption                      DebugOption;                                       // 0x130(0x50)(NoDestructor, NativeAccessSpecifierPublic)
	struct FRigUnit_FullbodyIK_WorkData          WorkData;                                          // 0x180(0x198)(Transient, NativeAccessSpecifierPublic)
	uint8                                        Pad_4839[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
