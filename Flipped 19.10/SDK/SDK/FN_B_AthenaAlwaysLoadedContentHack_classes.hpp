...
public:
	...
	TArray<class UObject*>                       HardObjectList;                                    // 0x228(0x10)(Edit, BlueprintVisible, DisableEditOnInstance)
	TArray<class UClass*>                        HardClassList;                                     // 0x238(0x10)(Edit, BlueprintVisible, DisableEditOnInstance)
