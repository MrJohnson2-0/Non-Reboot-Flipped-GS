...
class UClass* AHotfix_BuildingPropWithLootComp_Parent_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Hotfix_BuildingPropWithLootComp_Parent_C");

	return Clss;
}


// Hotfix_BuildingPropWithLootComp_Parent_C Hotfix_BuildingPropWithLootComp_Parent.Default__Hotfix_BuildingPropWithLootComp_Parent_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AHotfix_BuildingPropWithLootComp_Parent_C* AHotfix_BuildingPropWithLootComp_Parent_C::GetDefaultObj()
{
	static class AHotfix_BuildingPropWithLootComp_Parent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AHotfix_BuildingPropWithLootComp_Parent_C*>(AHotfix_BuildingPropWithLootComp_Parent_C::StaticClass()->DefaultObject);
...
void AHotfix_BuildingPropWithLootComp_Parent_C::OnReady_66411D114A9FDC07FF39F89B35B7E7AB(class AFortGameStateAthena* GameState, class UFortPlaylist* Playlist, struct FGameplayTagContainer& PlaylistContextTags)
{
	...
	Params::AHotfix_BuildingPropWithLootComp_Parent_C_OnReady_66411D114A9FDC07FF39F89B35B7E7AB_Params Parms{};
...
void AHotfix_BuildingPropWithLootComp_Parent_C::ExecuteUbergraph_Hotfix_BuildingPropWithLootComp_Parent(int32 EntryPoint, const struct FGameplayTagContainer& Temp_struct_Variable, class UFortPlaylist* Temp_object_Variable, class AFortGameStateAthena* Temp_object_Variable_1, class UFortAsyncAction_CurrentPlaylistReady* CallFunc_PlaylistDataReadyAsync_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_RowToBool_ReturnValue, bool CallFunc_RowToBool_ReturnValue_1, float CallFunc_RandomFloatInRange_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FRotator& CallFunc_K2_GetActorRotation_ReturnValue, float CallFunc_BreakRotator_Roll, float CallFunc_BreakRotator_Pitch, float CallFunc_BreakRotator_Yaw, bool CallFunc_IsValid_ReturnValue_1, float CallFunc_Add_FloatFloat_ReturnValue, const struct FRotator& CallFunc_MakeRotator_ReturnValue, class AFortGameStateAthena* K2Node_CustomEvent_GameState, class UFortPlaylist* K2Node_CustomEvent_Playlist, const struct FGameplayTagContainer& K2Node_CustomEvent_PlaylistContextTags, bool CallFunc_IsValid_ReturnValue_2, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FVector& CallFunc_Add_VectorVector_ReturnValue, class UParticleSystemComponent* CallFunc_SpawnEmitterAtLocation_ReturnValue)
{
	...
	Params::AHotfix_BuildingPropWithLootComp_Parent_C_ExecuteUbergraph_Hotfix_BuildingPropWithLootComp_Parent_Params Parms{};
