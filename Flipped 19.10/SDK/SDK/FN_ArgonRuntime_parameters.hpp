...
struct UArgonTicketComponent_GetArgonMutator_Params
{
public:
	class AFortAthenaMutator_Argon*              ReturnValue;                                       // 0x0(0x8)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct AFortAthenaMutator_Argon_ShouldShowNearbyTicketIndicators_Params
{
public:
	bool                                         ReturnValue;                                       // 0x0(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct AFortAthenaMutator_Argon_IsInSafeZone_Params
{
public:
	...
	uint8                                        Pad_3725[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	TArray<float>                                OutSquadmatePcts;                                  // 0x8(0x10)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
	...
	TArray<struct FArgonTeamProgressBarInfo>     OutEnemyProgressInfos;                             // 0x20(0x10)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
struct AFortAthenaMutator_Argon_FindSpawnLocationInSafeZone_Params
{
public:
	struct FVector                               InOutSpawnLocation;                                // 0x0(0xC)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
