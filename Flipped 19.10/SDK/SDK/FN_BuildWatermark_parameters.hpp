...
{
public:
	struct FFortTeamMemberInfo                   PlayerInfo;                                        // 0x0(0x230)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
};
...
public:
	...
	struct FFortTeamMemberInfo                   K2Node_CustomEvent_PlayerInfo;                     // 0x30(0x230)(ConstParm, HasGetValueTypeHash)
};
