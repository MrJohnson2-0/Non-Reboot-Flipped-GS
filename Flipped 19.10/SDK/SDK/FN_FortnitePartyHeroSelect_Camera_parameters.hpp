...
public:
	...
	TArray<class ATVPostProcessBP_C*>            CallFunc_GetAllActorsOfClass_OutActors;            // 0x110(0x10)(ReferenceParm)
	...
	struct FHitResult                            CallFunc_K2_SetRelativeRotation_SweepHitResult;    // 0x128(0x9C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	class AFortTimeOfDayManager*                 CallFunc_GetTimeOfDayManagerFromContext_ReturnValue; // 0x1D0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
