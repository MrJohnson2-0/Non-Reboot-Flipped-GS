...
public:
	...
	class UFortGameplayDataTrackerComponent*     DataTrackerComponent;                              // 0x1C0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         DataTrackerAssigned;                               // 0x1C8(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_6A43[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UClass*                                DataTrackerComponentClass;                         // 0x1D0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortGameplayDataTrackerComponentManager* DataTrackerComponentManager;                       // 0x1D8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         AwaitingCooldownBeforeShutoff;                     // 0x1E0(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_6A44[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class USoundMix*                             SoundMix;                                          // 0x1E8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FScalableFloat                        EnabledDataRow;                                    // 0x1F0(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
	TArray<struct FScalableFloat>                TrackMixStateVolumeDataRows;                       // 0x218(0x10)(Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                         MixPushed;                                         // 0x228(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_6A45[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        DataTrackerUpdateTime;                             // 0x22C(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
