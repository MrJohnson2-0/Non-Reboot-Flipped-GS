...
class UClass* IEntityAbilityInterface::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class IEntityAbilityInterface* IEntityAbilityInterface::GetDefaultObj()
{
	static class IEntityAbilityInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<IEntityAbilityInterface*>(IEntityAbilityInterface::StaticClass()->DefaultObject);
