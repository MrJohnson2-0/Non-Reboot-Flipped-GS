...
public:
	...
	TArray<class FName>                          Tags;                                              // 0x58(0x10)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_1A47[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TArray<class UProceduralContentVariationsWeightsModifier*> Modifiers;                                         // 0x0(0x10)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<class UProceduralDensityModifier*>    Modifiers;                                         // 0x0(0x10)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<class UProceduralScaleModifier*>      Modifiers;                                         // 0x10(0x10)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<class UProceduralRotationModifier*>   Modifiers;                                         // 0x0(0x10)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
