...
{
public:
	struct FMotoSynthRuntimeSettings             Settings;                                          // 0x28(0xC8)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	class UMotoSynthPreset*                      MotoSynthPreset;                                   // 0x6C0(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_226C[0x114];                                   // Fixing Size Of Struct [ Dumper-7 ]
