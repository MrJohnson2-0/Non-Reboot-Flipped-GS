...
{
public:
	class UFortTaggedSoundBank*                  TaggedSoundBank;                                   // 0x1C0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
