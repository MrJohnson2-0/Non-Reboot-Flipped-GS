...
public:
	...
	bool                                         TransitionActive;                                  // 0x23C(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UTimeSynthVolumeGroup*>         VolumeGroups;                                      // 0x248(0x10)(Edit, BlueprintVisible, DisableEditOnInstance)
	TArray<struct FTimeSynthClipHandle>          QueuedTransitions;                                 // 0x258(0x10)(Edit, BlueprintVisible, DisableEditOnInstance)
	TArray<class UBP_TimeSynthTrackComponent_C*> QueuedTracks;                                      // 0x268(0x10)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	bool                                         IsPlaying;                                         // 0x278(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         Debug;                                             // 0x279(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_764D[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         IsStoppedPermenant;                                // 0x288(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	void ExecuteUbergraph_BP_TimeSynthController_Base(int32 EntryPoint, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, int32 K2Node_CustomEvent_Index, float K2Node_CustomEvent_Volume_Multiplier, float CallFunc_MapRangeClamped_ReturnValue, class UTimeSynthVolumeGroup* CallFunc_Array_Get_Item);
};
