...
class UClass* UPlayspaceLogicComponent::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PlayspaceLogicComponent");

	return Clss;
}


// PlayspaceLogicComponent PlayspaceSystem.Default__PlayspaceLogicComponent
// (Public, ClassDefaultObject, ArchetypeObject)

class UPlayspaceLogicComponent* UPlayspaceLogicComponent::GetDefaultObj()
{
	static class UPlayspaceLogicComponent* Default = nullptr;

	if (!Default)
		Default = static_cast<UPlayspaceLogicComponent*>(UPlayspaceLogicComponent::StaticClass()->DefaultObject);
...
class UClass* APlayspaceSpawnActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class APlayspaceSpawnActor* APlayspaceSpawnActor::GetDefaultObj()
{
	static class APlayspaceSpawnActor* Default = nullptr;

	if (!Default)
		Default = static_cast<APlayspaceSpawnActor*>(APlayspaceSpawnActor::StaticClass()->DefaultObject);
