...
{
public:
	uint8                                        Pad_8C6[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_8CD[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	class UWidgetAnimation*                      Animation;                                         // 0x0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	class UWidget*                               Content;                                           // 0x8(0x8)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_8DD[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FSlateBrush                           Brush;                                             // 0x10(0xB0)(Edit, NativeAccessSpecifierPublic)
};
