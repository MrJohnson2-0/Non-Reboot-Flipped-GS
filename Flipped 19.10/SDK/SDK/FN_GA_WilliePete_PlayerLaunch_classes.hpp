...
public:
	...
	struct FScalableFloat                        LaunchHeightValue;                                 // 0xAC0(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
	class AB_HidingProp_WilliePete_C*            WilliePeteLauncher;                                // 0xAE8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTagContainer                 PlayerLaunchTag;                                   // 0xAF0(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	class UClass*                                GE_WilliePete_PlayerLaunch_ApplyGC;                // 0xB10(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AFortPlayerPawnAthena*                 TeleportExitPlayer;                                // 0xB18(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
