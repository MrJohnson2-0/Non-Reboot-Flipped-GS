...
void AEnemyPawn_Parent_Deimos_C::PlaySoundLibraryAudio(const struct FGameplayTag& Event_Name, class USoundLibrarySubsystem* CallFunc_GetWorldSubsystem_ReturnValue, const struct FSimpleSoundLibraryContextSettings& K2Node_MakeStruct_SimpleSoundLibraryContextSettings, bool CallFunc_IsDedicatedServer_ReturnValue, bool CallFunc_IsValid_ReturnValue, class USimpleSoundLibraryContext* CallFunc_SpawnObject_ReturnValue, const struct FSoundLibraryPlaySoundResult& CallFunc_PlaySound_OutResults)
{
	...
	Params::AEnemyPawn_Parent_Deimos_C_PlaySoundLibraryAudio_Params Parms{};
...
void AEnemyPawn_Parent_Deimos_C::OnBeginDeepWaterInteraction(const struct FVector& WaterSurfaceLocation, float WaterDepth)
{
	...
	Params::AEnemyPawn_Parent_Deimos_C_OnBeginDeepWaterInteraction_Params Parms{};
