...
{
public:
	uint8                                        Pad_12DD[0x1D0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<class UObject*>                       AssetsHotfixedFromIniFiles;                        // 0x228(0x10)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_12E0[0x60];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_12E4[0x23];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_12E6[0x1E];                                    // Fixing Size After Last Property  [ Dumper-7 ]
