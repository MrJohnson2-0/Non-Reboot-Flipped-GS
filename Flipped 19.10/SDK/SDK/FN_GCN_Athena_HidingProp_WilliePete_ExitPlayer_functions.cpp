...
class UClass* UGCN_Athena_HidingProp_WilliePete_ExitPlayer_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Athena_HidingProp_WilliePete_ExitPlayer_C");

	return Clss;
}


// GCN_Athena_HidingProp_WilliePete_ExitPlayer_C GCN_Athena_HidingProp_WilliePete_ExitPlayer.Default__GCN_Athena_HidingProp_WilliePete_ExitPlayer_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Athena_HidingProp_WilliePete_ExitPlayer_C* UGCN_Athena_HidingProp_WilliePete_ExitPlayer_C::GetDefaultObj()
{
	static class UGCN_Athena_HidingProp_WilliePete_ExitPlayer_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Athena_HidingProp_WilliePete_ExitPlayer_C*>(UGCN_Athena_HidingProp_WilliePete_ExitPlayer_C::StaticClass()->DefaultObject);
