...
class UClass* UGCN_Tether_Smash_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Tether_Smash_C");

	return Clss;
}


// GCN_Tether_Smash_C GCN_Tether_Smash.Default__GCN_Tether_Smash_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Tether_Smash_C* UGCN_Tether_Smash_C::GetDefaultObj()
{
	static class UGCN_Tether_Smash_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Tether_Smash_C*>(UGCN_Tether_Smash_C::StaticClass()->DefaultObject);
